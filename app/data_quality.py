...
MANUAL_PROPONENT_OVERRIDES_BY_URL = {
    "https://va.mite.gov.it/it-IT/Comunicazione/DettaglioUltimiProvvedimenti/5944": "SOLAR ENERGY QUATTRO S.R.L.",
    "https://va.mite.gov.it/it-IT/Comunicazione/DettaglioUltimiProvvedimenti/5959": "D2M Green Energy - Conche dell'Oro",
    "https://va.mite.gov.it/it-IT/Comunicazione/DettaglioUltimiProvvedimenti/5967": "Alta Capital 12 S.r.l.",
    "https://va.mite.gov.it/it-IT/Oggetti/Info/9254": "Alta Capital 12 S.r.l.",
    "https://va.mite.gov.it/it-IT/Oggetti/Info/10013": "D2M Green Energy - Conche dell'Oro",
    "https://www.sistema.puglia.it/portal/page/portal/SistemaPuglia/DettaglioInfo?id=62782": "FRI-EL SOLAR S.r.l.",
    "https://www.sistema.puglia.it/portal/page/portal/SistemaPuglia/DettaglioInfo?id=63601": "Energie Alternative s.r.l.",
    "https://www.sistema.puglia.it/portal/page/portal/SistemaPuglia/DettaglioInfo?id=62760": "IPC PUGLIA s.r.l.",
    "https://va.mite.gov.it/it-IT/Oggetti/Info/9409": "SOLAR ENERGY QUATTRO S.R.L.",
    "https://www.sistema.puglia.it/portal/page/portal/SistemaPuglia/DettaglioInfo?id=63255": "Luminora Specchione S.r.l.",
    "https://www.sistema.puglia.it/portal/page/portal/SistemaPuglia/DettaglioInfo?id=63201": "BLUSOLAR ASCOLI SATRIANO 1 S.r.l.",
    "https://www.sistema.puglia.it/portal/page/portal/SistemaPuglia/DettaglioInfo?id=63220": "GDR Solare s.r.l.",
    "https://www.sistema.puglia.it/portal/page/portal/SistemaPuglia/DettaglioInfo?id=63777": "SunEdison Mediterraneo 06 S.r.l.",
    "https://www.sistema.puglia.it/portal/page/portal/SistemaPuglia/DettaglioInfo?id=63237": "HEPV20 S.r.l.",
    "https://www.sistema.puglia.it/portal/page/portal/SistemaPuglia/DettaglioInfo?id=63334": "DAG ENERGY s.r.l.",
    "https://www.sistema.puglia.it/portal/page/portal/SistemaPuglia/DettaglioInfo?id=62817": "APRICENA PV S.r.l.",
    "https://va.mite.gov.it/it-IT/Oggetti/Info/8133": "EDISON S.p.A.",
    "https://va.mite.gov.it/it-IT/Oggetti/Info/8394": "Atlas Solar 1 S.r.l.",
    "https://va.mite.gov.it/it-IT/Oggetti/Info/9270": "NEREIDI S.R.L.",
    "https://va.mite.gov.it/it-IT/Oggetti/Info/8815": "Agrovoltaica S.r.l.",
    "https://va.mite.gov.it/it-IT/Oggetti/Info/8274": "ELLOMAY SOLAR ITALY THREE S.r.l.",
    "https://va.mite.gov.it/it-IT/Oggetti/Info/11579": "Verus S.r.l.",
    "https://va.mite.gov.it/it-IT/Oggetti/Info/8468": "Sonnedix San Gabriele S.R.L.",
    "https://va.mite.gov.it/it-IT/Oggetti/Info/10052": "H2-ERA GREEN VALLEY SRL",
    "https://va.mite.gov.it/it-IT/Oggetti/Info/11409": "Cagliari Solar 2018 S.r.l.",
    "https://va.mite.gov.it/it-IT/Oggetti/Info/8967": "EG DOLOMITI S.r.l.",
    "https://va.mite.gov.it/it-IT/Oggetti/Info/9575": "ELETTRA SOL S.R.L.",
    "https://va.mite.gov.it/it-IT/Oggetti/Info/9264": "EG PASCOLO SRL",
    "https://va.mite.gov.it/it-IT/Oggetti/Info/8017": "Greendream1 srl",
}

MANUAL_PROPONENT_OVERRIDES_BY_TITLE_RULES = [
    {
        "title_contains": ["bordonaro"],
        "power_mw": 130.0,
        "proponent": "Alta Capital 12 S.r.l.",
        "reason": "manual_proponent_override_by_title_power",
    },
    {
        "title_contains": ["conche dell oro"],
        "power_mw": 80.031,
        "proponent": "D2M Green Energy - Conche dell'Oro",
        "reason": "manual_proponent_override_by_title_power",
    },
    {
        "title_contains": ["potenza di 42 334", "salice salentino"],
        "power_mw": 42.334,
        "proponent": "SOLAR ENERGY QUATTRO S.R.L.",
        "reason": "manual_proponent_override_by_title_power",
    },
]
...
MANUAL_EXCLUDE_COMPLETED_SMALL_PROJECTS = [
    ...
    # titoli diversi per lo stesso procedimento.
    {
        ...
        "municipality_norm": "santa vittoria d alba",
        "title_contains": ["fotovoltaico"],
        "reason": "manual_exclude_completed_small_project",
    },
    {
        "source_norm": "piemonte",
        "municipality_norm": "ghislarengo",
    ...
    {
        "source_norm": "piemonte",
        "title_norm": "impianto fotovoltaico a terra e su coperture",
        "reason": "manual_exclude_completed_small_project",
    },
]
...
def manual_url_key(url: str) -> str:
    url = str(url or "").strip()
    if not url:
        return ""
    return specific_url_key(url) or url.rstrip("/").lower()


MANUAL_PROPONENT_OVERRIDES_BY_URL_KEY = {
    manual_url_key(url): value
    for url, value in MANUAL_PROPONENT_OVERRIDES_BY_URL.items()
}
...
def manual_power_matches(actual: Any, expected: float | None) -> bool:
    if expected is None:
        return True
    actual_float = parse_number_locale(str(actual or ""))
...
def manual_proponent_title_match(row: dict[str, Any]) -> tuple[str | None, str | None]:
    c = canonical_record(row)
    title_norm = c.get("title_norm") or norm_text(c.get("title") or "")
    power_value = c.get("power_mw")

    for rule in MANUAL_PROPONENT_OVERRIDES_BY_TITLE_RULES:
        terms = [norm_text(t) for t in rule.get("title_contains", [])]
        if terms and not all(term in title_norm for term in terms):
            continue
        if not manual_power_matches(power_value, rule.get("power_mw")):
            continue
        return rule.get("proponent"), rule.get("reason", "manual_proponent_override_by_title")

    return None, None


def manual_exclusion_match(row: dict[str, Any]) -> dict[str, Any] | None:
    c = canonical_record(row)

    for rule in MANUAL_EXCLUDE_COMPLETED_SMALL_PROJECTS:
        if c["source_norm"] != rule["source_norm"]:
            continue

        municipality_rule = rule.get("municipality_norm")
        if municipality_rule:
            municipality_norm = c["municipality_norm"] or ""
            title_norm = c["title_norm"] or ""
            # Alcuni collector mettono il comune nel titolo ma non nel campo comune.
            if municipality_rule not in municipality_norm and municipality_rule not in title_norm:
                continue

        exact_title = rule.get("title_norm")
        if exact_title and c["title_norm"] == exact_title:
            return rule

        title_contains = rule.get("title_contains") or []
        if title_contains:
            normalized_needles = [norm_text(item) for item in title_contains if norm_text(item)]
...
def apply_manual_data_fixes(rows: list[dict[str, Any]]) -> tuple[list[dict[str, Any]], list[dict[str, Any]]]:
    ...
    for idx, row in enumerate(rows):
        ...
        exclude_rule = manual_exclusion_match(row)
        if exclude_rule:
            actions.append({
                "idx": idx,
                "source": c["source"],
        ...
        new_row = dict(row)
        key = manual_url_key(c["url"])
        new_proponent = MANUAL_PROPONENT_OVERRIDES_BY_URL_KEY.get(key)
        override_reason = "manual_proponent_override_by_url" if new_proponent else ""

        if not new_proponent:
            new_proponent, override_reason = manual_proponent_title_match(new_row)

        if new_proponent:
            old_proponent = str(get_field(new_row, PROPONENT_FIELDS) or "").strip()
            if norm_text(old_proponent) != norm_text(new_proponent):
                set_field_if_present(new_row, PROPONENT_FIELDS, new_proponent)
                actions.append({
                    "idx": idx,
                    "source": c["source"],
                    "title": c["title"],
                    "url": c["url"],
                    "field": "proponent",
                    "old_value": old_proponent,
                    "new_value": new_proponent,
                    "reason": override_reason or "manual_proponent_override",
                    "action": "updated",
                })

        fixed_rows.append(new_row)

    return fixed_rows, actions
...
def make_audit_markdown(original_rows, deduped_rows, accepted, rejected, suspicious, top_before, top_after, repairs=None) -> str:
    ...
    lines += ["", "## File generati", "", "- `reports/data_deduped.json`", "- `reports/dedupe_audit.md`", "- `reports/dedupe_accepted.csv`", "- `reports/dedupe_rejected.csv`", "- `reports/dedupe_suspicious_rows.csv`", "- `reports/dedupe_field_repairs.csv`", "- `reports/dedupe_manual_actions.csv`", "- `reports/dedupe_top_excluded.csv`", "- `reports/dedupe_project_key_splits.csv`", ""]
    return "\n".join(lines)
...
def main() -> int:
    ...
    if args.no_field_repair:
        working_rows = manually_fixed_rows
        field_repairs = []
    else:
        working_rows, field_repairs = repair_obvious_fields(manually_fixed_rows)

    repairs = manual_actions + field_repairs
    ...
    # V15: riapplica gli override manuali anche dopo la deduplica.
    # Serve quando la riga finale eredita un URL/provvedimento diverso dalla scheda MASE
    # o quando il merge sceglie la variante senza proponente.
    deduped_rows, post_dedupe_manual_actions = apply_manual_data_fixes(deduped_rows)
    manual_actions = manual_actions + [
        dict(action, stage="post_dedupe")
        for action in post_dedupe_manual_actions
    ]
    ...
    if isinstance(data, list):
        ...
        new_data["data_quality"] = {
            ...
            "manual_proponent_overrides": sum(1 for r in manual_actions if r.get("reason") == "manual_proponent_override_by_url"),
            "manual_excluded_records": sum(1 for r in manual_actions if r.get("action") == "excluded"),
            ...
            "rules": {
                ...
                "manual_proponent_overrides_by_url": True,
    ...
    write_csv(reports_dir / "dedupe_manual_actions.csv", manual_actions)
