...
class SiciliaCollector(BaseCollector):
    ...
    def _extract_municipalities(self, text: str) -> list[str]:
        ...
        # Pattern molto affidabile: "Nome Comune (XX)".
    ...
    def _clean_municipality(self, value: str) -> str | None:
        ...
        value = re.sub(r"^(?:e|ed|di|del|della|dello|dei|degli|in|nel|nella)\s+", "", value, flags=re.IGNORECASE)
        ...
        if normalized in {"sicilia", "provincia", "comune", "comuni", "sito", "siti"}:
            return None
