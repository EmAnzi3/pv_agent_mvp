...
@media (max-width: 720px) {
  /* Pipeline completa in formato card, se il table ha ID/classe dedicata */
  #pipelineTable,
  ...
  #pipelineTable thead,
  table.pipeline-table thead,
  .pipeline-table table thead {
    display: none !important;
  }

  #pipelineTable tbody,
  table.pipeline-table tbody,
  ...
  #pipelineTable tr,
  table.pipeline-table tr,
  .pipeline-table table tr {
    display: block !important;
    margin-bottom: 12px !important;
  ...
  #pipelineTable td:last-child,
  table.pipeline-table td:last-child,
  .pipeline-table table td:last-child {
    border-bottom: 0 !important;
  }

  #pipelineTable td::before,
  table.pipeline-table td::before,
  .pipeline-table table td::before {
  ...
  #pipelineTable td:nth-child(1)::before,
  table.pipeline-table td:nth-child(1)::before,
  .pipeline-table table td:nth-child(1)::before { content: "Fonte"; }

  #pipelineTable td:nth-child(2)::before,
  table.pipeline-table td:nth-child(2)::before,
  .pipeline-table table td:nth-child(2)::before { content: "Regione"; }

  #pipelineTable td:nth-child(3)::before,
  table.pipeline-table td:nth-child(3)::before,
  .pipeline-table table td:nth-child(3)::before { content: "Provincia"; }

  #pipelineTable td:nth-child(4)::before,
  table.pipeline-table td:nth-child(4)::before,
  .pipeline-table table td:nth-child(4)::before { content: "Comune/i"; }

  #pipelineTable td:nth-child(5)::before,
  table.pipeline-table td:nth-child(5)::before,
  .pipeline-table table td:nth-child(5)::before { content: "Progetto"; }

  #pipelineTable td:nth-child(6)::before,
  table.pipeline-table td:nth-child(6)::before,
  .pipeline-table table td:nth-child(6)::before { content: "Proponente"; }

  #pipelineTable td:nth-child(7)::before,
  table.pipeline-table td:nth-child(7)::before,
  .pipeline-table table td:nth-child(7)::before { content: "Tipo"; }

  #pipelineTable td:nth-child(8)::before,
  table.pipeline-table td:nth-child(8)::before,
  .pipeline-table table td:nth-child(8)::before { content: "MW"; }

  #pipelineTable td:nth-child(9)::before,
  table.pipeline-table td:nth-child(9)::before,
  .pipeline-table table td:nth-child(9)::before { content: "Link"; }
...
/* === END MOBILE RESPONSIVE PATCH v1 === */


/* === MOBILE RESPONSIVE PATCH v2 - TRUE MOBILE VIEW === */
@media (max-width: 760px) {
  ...
  /* Grafici: su mobile non devono essere poster murali in miniatura */
  .chart-card {
  ...
  /* La ciambella fonte su mobile ? poco utile: compatta e senza dominare la pagina */
  #sourceChart + .legend,
  .chart-card .legend {
    font-size: 11px !important;
  }

  /* Tabelle: niente microcelle inutilizzabili */
  table {
    width: 100% !important;
  ...
  /* Nasconde colonne troppo tecniche nelle tabelle su mobile, quando presenti */
  td:nth-child(1),
  td:nth-child(2),
  td:nth-child(3),
  td:nth-child(4),
  ...
  /* Nota/metodo lettura pi? compatta */
  .note,
  .method,
  .callout,
  .info-box {
  ...
  /* Legende Chart.js: su mobile meno invasive */
  .chartjs-legend,
  .legend {
...
/* === END MOBILE RESPONSIVE PATCH v2 === */
...
<body>
  ...
  <script>
    ...
    function initCharts() {
      ...
      const mergedSourceCounts = Object.values((summary.source_counts || []).reduce((acc, x) => {
        const label = x.label || 'n/d';
        acc[label] = acc[label] || { label, count: 0 };
        acc[label].count += Number(x.count || 0);
        return acc;
      ...
      new Chart(document.getElementById('sourceChart'), {
        type: 'doughnut',
        data: {
          labels: mergedSourceCounts.map(x => x.label),
          datasets: [{ label: 'Record', data: mergedSourceCounts.map(x => x.count), backgroundColor: chartColors(mergedSourceCounts.length), borderWidth: 0 }]
        },
        options: {
          responsive: true,
          plugins: {
