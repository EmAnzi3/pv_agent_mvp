...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .filters {
      display: grid;
      grid-template-columns: 1.3fr repeat(7, minmax(130px, 1fr));
      gap: 12px;
      margin-bottom: 14px;
    }
...
<body>
  ...
  <script>
    ...
    function initCharts() {
      ...
      new Chart(document.getElementById('sourceMwChart'), {
        ...
        data: {
          ...
          datasets: [{ label: 'MW', data: sourceMw.map(x => x.mw) }]
        },
    ...
    function attachEvents() {
      ['searchInput', 'dataKindFilter', 'sourceFilter', 'regionFilter', 'provinceFilter', 'statusFilter', 'sortFieldFilter', 'sortDirectionFilter'].forEach(id => {
